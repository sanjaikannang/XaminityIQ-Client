...
export const examsApiService = apiInstance.injectEndpoints({
    endpoints: (build) => ({
        ...
        getAssignedStudents: build.query<GetAssignedStudentsResponse, string>({
            query: (examId) => ({
                url: api.exams.getAssignedStudents(examId),
                method: "GET",
            }),
            providesTags: ['assigned-students'],
        }),
        getAttemptRecording: build.query<GetAttemptRecordingResponse, string>({
            query: (attemptId) => ({
                url: api.exams.getAttemptRecording(attemptId),
                method: "GET",
            }),
        }),
