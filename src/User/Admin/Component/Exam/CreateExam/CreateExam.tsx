...
const CreateExam = () => {
    ...
    const toggleExamInfo = () => {
        setIsExamInfoOpen(!isExamInfoOpen);
    };

    const toggleTargetAudience = () => {
        setIsTargetAudienceOpen(!isTargetAudienceOpen);
    };
    ...
    const toggleExamStructure = () => {
        setIsExamStructureOpen(!isExamStructureOpen);
    };
