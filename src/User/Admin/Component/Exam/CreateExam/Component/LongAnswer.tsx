                    ...
                    <div className="p-4 space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) => onUpdateQuestion(sectionId, questionIndex, 'minWordCount', parseInt(e.target.value) || 50)}
                                    className={`w-full px-3 py-2 border rounded-md focus:outline-none duration-200 text-gray-900 placeholder-gray-500 ${hasError('minWordCount') ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                        }`}
                                    placeholder="Minimum words expected"
                                />
                                {hasError('minWordCount') && (
                                    <p className="text-xs text-red-600 mt-1">{getErrorMessage('minWordCount')}</p>
                                )}
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">
                                ...
                                <input
                                    ...
                                    onChange={(e) => onUpdateQuestion(sectionId, questionIndex, 'maxWordCount', parseInt(e.target.value) || 100)}
                                    className={`w-full px-3 py-2 border rounded-md focus:outline-none duration-200 text-gray-900 placeholder-gray-500 ${hasError('maxWordCount') ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                        }`}
                                    placeholder="Maximum words expected"
                                />
                                {hasError('maxWordCount') && (
                                    <p className="text-xs text-red-600 mt-1">{getErrorMessage('maxWordCount')}</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                onChange={(e) => onUpdateQuestion(sectionId, questionIndex, 'modelAnswer', e.target.value)}
                                className={`w-full px-3 py-2 border rounded-md focus:outline-none duration-200 text-gray-900 placeholder-gray-500 ${hasError('modelAnswer') ? 'border-red-500 bg-red-50' : 'border-gray-300'
                                    }`}
                                placeholder="Provide a model answer or key points that should be covered in the response..."
                            />
                            {hasError('modelAnswer') && (
                                <p className="text-xs text-red-600 mt-1">{getErrorMessage('modelAnswer')}</p>
                            )}
                        </div>
                        ...
                        <div className="p-4 rounded-md border border-gray-300 mt-4">
                            ...
                            {question.keywords?.map((keyword, index) => (
                                <div key={index} className="flex items-center space-x-2 mb-3 relative">
                                    ...
                                    {hasError(`keywords.${index}`) && (
                                        <div className="absolute mt-12 text-xs text-red-600 z-10">
