    ...
    return (
        <>
            <div className="space-y-6 mb-6">
                ...
                {/* Section 2: Employment & Contact Details Skeleton */}
                        ...
                        <div className="space-y-4">
                            {[...Array(9)].map((_, index) => (
                                <div key={index} className="flex justify-between items-start py-3 border-b border-borderLight">
                                    <div className="h-4 bg-bgSecondary rounded animate-pulse w-28"></div>
                ...
                {/* Section 4: Work Experience Skeleton */}
                <div className="bg-whiteColor rounded-xl border border-borderDefault p-4">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="w-10 h-10 rounded-lg bg-primary/10 animate-pulse"></div>
                        <div className="h-6 bg-bgSecondary rounded animate-pulse w-48"></div>
                    ...
                    <div className="mt-6 space-y-6">
                        {[...Array(2)].map((_, index) => (
                            <div key={index} className="relative flex gap-4">
                                <div className="flex flex-col items-center">
                                    <div className="w-10 h-10 rounded-full bg-primary/10 animate-pulse"></div>
                                    {index !== 1 && <div className="w-0.5 h-24 bg-borderLight mt-2"></div>}
                                </div>
                                <div className="flex-1">
                                    <div className="bg-bgSecondary rounded-xl p-4 border border-borderDefault">
                                        <div className="flex items-center justify-between mb-2">
                                            <div className="h-5 bg-borderLight rounded animate-pulse w-1/2"></div>
                                            {index === 0 && (
                                                <div className="h-6 w-16 bg-success/10 rounded-full animate-pulse"></div>
                                            )}
                                        </div>
                                        <div className="h-4 bg-borderLight rounded animate-pulse w-1/3 mb-3"></div>
                                        <div className="grid grid-cols-2 gap-3">
                                            {[...Array(3)].map((_, idx) => (
                                                <div key={idx} className="h-4 bg-borderLight rounded animate-pulse"></div>
                                            ))}
                                        ...
                                        <div className="mt-3">
                                            <div className="h-3 bg-borderLight rounded animate-pulse w-full"></div>
                                            <div className="h-3 bg-borderLight rounded animate-pulse w-3/4 mt-2"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default FacultyDetailSkeleton;